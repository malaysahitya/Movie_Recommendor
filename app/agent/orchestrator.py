...
async def run_agent_pipeline(request: RecommendationRequest) -> RecommendationResponse:
    """
    Orchestrates the LLM-Driven 4-Agent Pipeline with OpenTelemetry Trace Spans & Guardrails:
      1. Guardrail Validation
      2. Context Management Loading
      3. Planner Agent -> Pre-execution INTENT & Post-execution OUTCOME wrapped in OpenTelemetry Span
      4. Researcher Agent -> Pre-execution INTENT & Post-execution OUTCOME wrapped in OpenTelemetry Span
      5. Analysis Agent -> Pre-execution INTENT & Post-execution OUTCOME wrapped in OpenTelemetry Span
      6. Explainer Agent -> Pre-execution INTENT & Post-execution OUTCOME wrapped in OpenTelemetry Span
    ...
    # 7. Non-blocking Background Memory Saver
